...
/**
 * AutoNateAI Intel — Region Dossier API
  ...
  try {
    ...
    const [countryResult, wikiResult, hosResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[AutoNateAI Intel] Country fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[AutoNateAI Intel] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[AutoNateAI Intel] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
