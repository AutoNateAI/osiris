...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Brand
    "autonateai", "autonateai intel", "intel.autonateai.com",
  ],
  authors: [{ name: "AutoNateAI", url: SITE_URL }],
  creator: "AutoNateAI",
  publisher: "AutoNateAI",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "AutoNateAI Intel",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "AutoNateAI Intel — OSINT Toolkit & Intelligence Platform",
  alternateName: ["AutoNateAI Intel", "AutoNateAI OSINT", "AutoNateAI Intelligence"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
