...
function EntityDetailModal({ entity, onClose }: { entity: any; onClose: () => void }) {
  ...
  const rows = isPha
    ...
    : [['Branch', entity.branch], ['Role', entity.role], ['Chamber', entity.chamber || 'N/A'], ['Origin', [entity.origin_city, entity.origin_state].filter(Boolean).join(', ') || 'Unknown'], ['Represents', entity.represented_state || entity.state], ['Party', entity.party || 'Nonpartisan/Unknown'], ['District', entity.district ?? 'Statewide/N/A']];
  const bars = isPha
